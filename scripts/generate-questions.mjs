...
const MAX_CALLS_PER_RUN = 100; // 100 calls/run × ~9 runs/day ≈ 900/day, under Gemini's 1,000/day cap
...
async function main() {
  ...
  for (const w of counts) {
    ...
    await sleep(5000); // 12 calls/min — safely under Gemini's 15/min free-tier limit
  }
